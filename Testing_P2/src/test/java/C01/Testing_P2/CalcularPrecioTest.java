...
public class CalcularPrecioTest {
	...
	public double CalcularPrecioBillete(int nivel, int edad, boolean profesional, boolean enfermo, boolean sintomas, boolean contacto, int plazasLibres, int plazasN){
		double precio = 14.0;
	...
	public int calcularPlazasNormales (int plazas, int nivel) {
		if (nivel < 2) {
			return plazas;
		}
		else if (nivel < 3) {
	...
	public int calcularNivel (int casos) {
		int nivel;
		if (casos < 100) {
			nivel = 0;
		}
